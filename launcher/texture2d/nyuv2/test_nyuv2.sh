...
pretrain_path='./../../../pretrain/texture_2d/Nyu_v2_texture2d_branch.pth.tar'

python $script --batch_size 16 --cuda --nworkers 4 --range01 --dataset_path $dataset_path \
		--dataset_folder $dataset_folder --test_split $test_split --classname $classname \
		--nclass 10 --pretrain_path $pretrain_path  
