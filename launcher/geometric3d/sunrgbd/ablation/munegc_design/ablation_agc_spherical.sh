...
pretrain_path='./../../../../../pretrain/geometric_3d/ablation/munegc_design/agc_spherical.pth.tar'
...
python $script --batch_size 32 --batch_parts 8 --cuda --nworkers 4 --dataset_path $dataset_path \
		...
		--range01 --pos_int16 --model_config $model --edge_attr posspherical --fnet_widths [128] \
		--fnet_llbias --pretrain_path $pretrain_path
