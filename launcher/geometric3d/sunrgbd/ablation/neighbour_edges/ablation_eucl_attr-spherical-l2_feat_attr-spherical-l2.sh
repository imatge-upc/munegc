...
pretrain_path='./../../../../../pretrain/geometric_3d/ablation/neighbour_edges/eucl_attr-spherical-l2_feat_attr-spherical-l2.pth.tar'
...
python $script --batch_size 32 --batch_parts 8 --cuda --nworkers 4 --dataset_path $dataset_path \
		...
		--range01 --pos_int16 --model_config $model --edge_attr posspherical-featurel2  --fnet_widths [128] \
